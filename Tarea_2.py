...
def S_hl_store(k, e, A_tapa, r_o, L, t_s1, t_s2, t_s3, t_s4, t_s5, t_s6, t_s7, t_s8, t_s9, t_s10, t_s11, t_inf):
    ...
    s_hl_tapa = -( UA_tapa*(t_s1 - t_inf)/t_s1 + UA_tapa*(t_s11 - t_inf)/t_s11 ) 
    s_hl_centro = -( UA_centro*(t_s2 - t_inf)/t_s2 +
                     UA_centro*(t_s3 - t_inf)/t_s3 +
                     UA_centro*(t_s4 - t_inf)/t_s4 +
                     UA_centro*(t_s5 - t_inf)/t_s5 +
                     UA_centro*(t_s6 - t_inf)/t_s6 +
                     UA_centro*(t_s7 - t_inf)/t_s7 +
                     UA_centro*(t_s8 - t_inf)/t_s8 +
                     UA_centro*(t_s9 - t_inf)/t_s9 +
                     UA_centro*(t_s10 - t_inf)/t_s10
                     )
...
df['Error'] = df['H_store'] - df['H_flow_acumulado'] + df['H_hl_store_acumulado']
